...
def downloadImg():
    ...
    imgOutputName = os.path.join(r'C:\Users\Administrator\Downloads\pictures', imgName)
...
def moveBriefImgs():
    ...
    destinationPath = os.path.join(
        r"C:\productData", targetDir, "synopsisImgDir"
    )
...
def moveDetialImgs():
    ...
    originalPath = r"C:\Users\Administrator\Downloads\pictures"
    destinationPath = os.path.join(
        r"C:\productData", targetDir, "detailImageDir"
    )
...
def downloadConcatenateImgs():
    ...
    imgLinksFile = r"C:\productData\productDetial.html"
